...
return (
    <Grid container sx={{my:'5px',height:'800px', display:"flex", flexWrap: 'nowrap'}}>
            <Box style={{width: '300px', height: '100%', padding: '30px', opacity: '0.8', display: 'flex', flexDirection: 'column',
